            ...
            <tr>
              ...
              <td>
                <div class="btn-group" role="group">
                  <a href='{{url('kursus/'.$item->id_course.'/edit')}}' class="btn btn-warning btn-sm mr-1">Edit</a>
                  <form onsubmit="return confirm('Yakin akan menghapus data?')" class='d-inline' action="{{url('kursus/'.$item->id_course)}}" method="post">
                    @csrf
                    @method('DELETE')
