...
<form action='{{url('magang')}}' method='post'>
@csrf
<a href='{{url('magang')}}' class="btn btn-primary">KEMBALI</a>
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name='id_internship' value="{{Session::get('id_internship')}}" id="internshipId">
          </div>
        </div>
        <div class="mb-3 row">
          <label for="duration" class="col-sm-2 col-form-label">Perusahaan:</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" name='perusahaan' value="{{Session::get('perusahaan')}}" id="perusahaan">
          </div>
        </div>
        <div class="mb-3 row">
          <label for="rating" class="col-sm-2 col-form-label">Role:</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" name='role' value="{{Session::get('role')}}" id="role">
          </div>
        </div>
        <div class="mb-3 row">
          <label for="rating" class="col-sm-2 col-form-label">Durasi:</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" name='durasi' value="{{Session::get('durasi')}}" id="durasi">
          </div>
        </div>
        <div class="mb-3 row">
